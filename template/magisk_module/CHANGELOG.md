...
* Temporary solution for [#35](https://github.com/Zzz-IT/SUI-Z/issues/35)
...
- Add adb root support (disabled by default, see description at [GitHub release](https://github.com/Zzz-IT/SUI-Z/releases))
