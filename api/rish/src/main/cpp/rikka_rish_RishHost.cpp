...
static jintArray RishHost_startHost(JNIEnv* env, jclass clazz, jbyteArray argBlock, jint argc,
                                    jbyteArray envBlock, jint envc, jbyteArray dirBlock, jbyte tty,
    ...
    if (pid > 0) {
        ...
        LOGD("istty stdin %d stdout %d stderr %d", isatty(STDIN_FILENO), isatty(STDOUT_FILENO),
